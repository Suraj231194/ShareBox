...
const GuestFileUpload = ({ guestFiles, updateFiles }) => {
  ...
  return (
    <div className="container bg-card text-card-foreground p-6 rounded-lg shadow-sm border border-border">
      <div className="header text-center mb-6">
        <h1 className="text-2xl font-bold text-primary mb-2">File Upload</h1>
        <p className="text-muted-foreground mb-4">Drag & drop files or click to browse</p>
      </div>

      <div
        className="border-2 border-dashed border-input rounded-xl p-10 text-center cursor-pointer transition-colors hover:border-primary hover:bg-primary/5 bg-muted/30"
      ...
      >
        ...
        <button
          className="mt-4 px-6 py-2 bg-secondary text-secondary-foreground rounded-full hover:bg-secondary/80 transition-colors font-medium"
          onClick={(e) => {
            e.stopPropagation();
            handleBrowseClick();
          }}
