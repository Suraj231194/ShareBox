...
const GuestDownload = () => {
  ...
  useEffect(() => {
    ...
    const fetchFile = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/files/g/${shortCode}`, {
  ...
  const verifyFile = async () => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/files/verifyGuestFilePassword`, {
        method: "POST",
